var ButterTexture1 = new THREE.TextureLoader().load('tex/cardboard.jpg');
var ButterTexture2 = new THREE.TextureLoader().load('tex/splash.jpg');
var ButterBumpTex = new THREE.TextureLoader().load('tex/cardboard-normal.jpg');
